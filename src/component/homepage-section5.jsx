...
function HomepageSection5() {
  return (
    <div className='homepage-section-5 d-flex align-items-center justify-content-center flex-column'>
        <img className='homepage-section-5-top-icon' src="/assets/section-4-icon.png" alt="section-4-icon" />
        <h1><b>Get</b> Involved</h1>
        <p className='text-center mb-0'>Throughout the Passover season, Masbia expects to distribute 10,000 raw food <br /> packages, which will include special holiday staples for families to be able to <br /> prepare their own Seder and Kosher for Passover </p>
